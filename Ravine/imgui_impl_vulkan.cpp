...
void ImGui_ImplVulkan_RenderDrawData(ImDrawData* draw_data, VkCommandBuffer command_buffer)
{
    ...
    // Upload Vertex and index Data:
    {
        ...
        err = vkMapMemory(g_Device, fd->VertexBufferMemory, 0, vertex_size, 0, reinterpret_cast<void**>(&vtx_dst));
        check_vk_result(err);
        err = vkMapMemory(g_Device, fd->IndexBufferMemory, 0, index_size, 0, reinterpret_cast<void**>(&idx_dst));
        check_vk_result(err);
